...
DizionarioMappe = {
    ...
    2: pygame.image.load(resource_path("mappe/mappa2.png")),
    3: pygame.image.load(resource_path("mappe/mappa3.png")),
    "m": pygame.image.load(resource_path("mappe/aggiuntaMappa.png"))
}
MiniMappe = {
...
def CaricaImmagini():
    ...
    schermataTitolo = pygame.image.load(resource_path("immagini/titolo.png"))
    sfondoMappe = pygame.image.load(resource_path("immagini/sfondoMappe.png"))
    personaggio = pygame.image.load(resource_path("immagini/personaggio.png"))
    proiettile = pygame.transform.scale(pygame.image.load(resource_path("immagini/weapon_gun.png")), (10, 10))
    zombie = pygame.image.load(resource_path("immagini/zombie.png"))
    sangue = pygame.image.load(resource_path("immagini/sangue.png"))
    sangue = pygame.transform.scale(sangue, (100, 100))
    cuore = pygame.transform.scale(pygame.image.load(resource_path("immagini/cuore.png")), (70, 70))
    cuoreBonus = pygame.transform.scale(pygame.image.load(resource_path("immagini/cuore.png")), (50, 50))
    fulmine = pygame.transform.scale(pygame.image.load(resource_path("immagini/fulmine.png")), (50, 50))
    rifornimenti = pygame.transform.scale(pygame.image.load(resource_path("immagini/risorse.png")), (40, 40))
    GameOver = pygame.transform.scale(pygame.image.load(resource_path("immagini/GAMEOVER.png")), (700, 700))
    uno = pygame.transform.scale(pygame.image.load(resource_path("immagini/uno.png")), (50, 50))
    due = pygame.transform.scale(pygame.image.load(resource_path("immagini/due.png")), (50, 50))
    tre = pygame.transform.scale(pygame.image.load(resource_path("immagini/tre.png")), (50, 50))
    quattro = pygame.transform.scale(pygame.image.load(resource_path("immagini/quattro.png")), (50, 50))
    nuovaMappa = pygame.transform.scale(pygame.image.load(resource_path("mappe/aggiuntaMappa.png")), (300, 250))
    boss = pygame.transform.scale(pygame.image.load(resource_path("immagini/boss.png")), (100, 100))
    mirino = pygame.transform.scale(pygame.image.load(resource_path("immagini\mirino.png")), (50, 50))
    SfondoMieMappe = pygame.image.load(resource_path("immagini/sfondoMieMappe.png"))
    bomba = pygame.transform.scale(pygame.image.load(resource_path("immagini/bomba.png")), (50, 50))
...
def CaricaSuoni():
    ...
    Suonoarma = pygame.mixer.Sound(resource_path('suoni/armaScarica.mp3'))
    suonoRicarica = pygame.mixer.Sound(resource_path('suoni/ricarica.mp3'))
    Suonosangue = pygame.mixer.Sound(resource_path('suoni/sangue.mp3'))
    SuonoDanno = pygame.mixer.Sound(resource_path('suoni/dolore.mp3'))
    SuonoBomba = pygame.mixer.Sound(resource_path('suoni/bomba.mp3'))
    Sottofondo = pygame.mixer.Sound(resource_path('suoni/sottofondo.mp3'))
...
def StatoIniziale():
    ...
    inizializza_font = resource_path("font/ZOMBIE.TTF")
 
    font = pygame.font.Font(inizializza_font, 36)
...
mappaTile = {
    "A" : pygame.image.load(resource_path("tile/prato.png")),
    "B" : pygame.image.load(resource_path("tile/fiume.png")),
    "C" : pygame.image.load(resource_path("tile/sentiero.png")),
    "D" : pygame.image.load(resource_path("tile/strada.png")),
    "E" : pygame.image.load(resource_path("tile/muro.png"))
    }
...
def MostraSceltaMappaPersonale(font):
    ...
    cartella = "MieMappe"
    file = []
    listaFile = os.listdir(resource_path(cartella))
            ...
            if not nomeInserito:
                ...
                for event in eventi:
                    ...
                    if n == 1 or n == 2 or n == 3:
                        ...
                        try:
                            nuovoPercorso = resource_path(MostraSceltaMappaPersonale(font))
                        except:
                            pass
